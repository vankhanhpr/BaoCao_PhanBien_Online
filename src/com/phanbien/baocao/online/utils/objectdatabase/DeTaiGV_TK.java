...
public class DeTaiGV_TK {
	...
	public String getGiangVienPB() {
		return GiangVienPB;
	}
	public void setGiangVienPB(String giangVienPB) {
		GiangVienPB = giangVienPB;
	}
	public String getGiangVienHD() {
		return GiangVienHD;
	}
	public void setGiangVienHD(String giangVienHD) {
		GiangVienHD = giangVienHD;
	}
	public String getUyVien() {
		return UyVien;
	}
	public void setUyVien(String uyVien) {
		UyVien = uyVien;
	}
